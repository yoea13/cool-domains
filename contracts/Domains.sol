...
// We make the contract "payable" by adding this to the constructor
  constructor(string memory _tld) payable ERC721("Yoea13 Name Service", "YNS") {
    tld = _tld;
    console.log("%s nombre del servicio de dominio deployado", _tld);
  }
